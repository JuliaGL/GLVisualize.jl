    ...
    precompile(Base.collect_to!, (Array{String, 1}, Base.Generator{Array{Ptr{Int8}, 1},typeof( Base.unsafe_string)}, Int64, Int64,))
    ...
    precompile(Base.unsafe_string, (Base.Cstring,))
    ...
    precompile(Base.unsafe_string, (Array{UInt8, 1},))
    ...
    precompile(Base._collect, (Array{Ptr{Int8}, 1}, Base.Generator{Array{Ptr{Int8}, 1},typeof( Base.unsafe_string)}, Base.EltypeUnknown, Base.HasShape,))
    ...
    precompile(Base.unsafe_string, (Ptr{UInt8}, Int32,))
